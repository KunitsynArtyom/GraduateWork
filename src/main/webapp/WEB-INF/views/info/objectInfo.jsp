...
<div class="container">
    ...
    <div class="list-group">
        ...
        <a class="list-group-item">
            ...
            <p class="list-group-item-text">${object.id}</p>
        </a>
    ...
    <div id="demo" class="collapse">
        <div class="container">
            ...
            <table class="table table-hover table-bordered">
                <body>
                <tr>
                    <th>Attribute Id</th><th>Attribute Name</th>
                </tr>
                <c:forEach items="${attributeList}" var="attribute">
                    <tr>
                        <td><a href="<spring:url value="/attribute/${attribute.id}"/>"><c:out value="${attribute.id}" /></a></td>
